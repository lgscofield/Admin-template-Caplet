								...
								<div class="col-lg-8" >
										<section class="panel">
												<header class="panel-heading">
														<h2><strong>Slider</strong> UI</h2>
														<label class="color">Plungin Jslider</label>
												</header>
												...
												<div class="panel-body">
														 <h4><strong>Single</strong> Slider </h4>
														  <div class="slider-wrapper">
														  	<input id="SliderSingle" type="slider" name="price" value="20" />	
														  </div> 
														  <hr>
														  
														  <h4><strong>Range</strong> Slider </h4>
														  <div class="slider-wrapper">
														  	<input id="Slider1" type="slider" name="price" value="30000.5;60000" />
														  </div> 
														  <hr>
														  
														  <h4><strong>Inline</strong> Slider</h4>
														  <div class="slider-wrapper" data-color="theme-inverse">
														  	Inline Text <span class="inline"><input id="Slider2" type="slider" name="price" value="5000;50000" /></span>	
														  </div> 
														  <hr>
														  
														  <h4><strong>Scale</strong> Slider</h4>
														  <div class="slider-wrapper" data-color="theme">
														  	<input id="Slider3" type="slider" name="area" value="25;75" />		
														  </div> 
														  <div class="slider-wrapper" data-color="warning">
														  	<input id="Slider4" type="slider" name="area" value="2;10" />	
														  </div> 
														  <hr>
														  
														  <h4><strong>Time</strong> Slider</h4>
														  <div class="slider-wrapper" data-color="green">
										...
										<section class="panel">
												<header class="panel-heading">
														<h2><strong>Slider</strong> UI</h2>
														<label class="color">With Jquery UI</label>
												</header>
												<div class="panel-tools  color " align="right" data-toolscolor="theme-inverse">
														<ul class="tooltip-area">
																<li><a href="javascript:void(0)" class="btn btn-collapse" title="Collapse"><i class="fa fa-sort-amount-asc"></i></a></li>
												...
												<div class="panel-body">
														 <h4><strong>Single</strong> Slider </h4><br>
																  <div id="ui-slider"></div>
														  <hr>
														  
														  <h4><strong>Range</strong> Slider </h4><br>
																<p>
														  ...
														  <hr>
														  <h4><strong>min</strong> Slider </h4><br>
																<p>
																<label for="amount-range-max">Maximum price:</label>
																<input type="text" id="amount-range-max" style="border:0; color:#f6931f;">
																</p>
																<div id="ui-slider-range-min"></div>
														  <hr>
														  
														  <h4><strong>Custom</strong> Color </h4><br>
																<div id="ui-slider-color" class="slider-color" data-color="warning"></div>
														  <hr>
												</div>
										</section>
								...
								<div class="col-lg-4">										
										<section class="panel">
												<header class="panel-heading sm">
														<h2> <strong>slider</strong> vertical </h2>
														<label class="color">With Jquery UI </label>
												</header>
												<div class="panel-body">
														<div id="swatch" class="well corner-flip flip-bg-white" data-color="#F4AD41">
															<h4><i class="fa fa-bar-chart-o"></i> <strong>Slider </strong>Colorpicker</h4>
															<p>Vertical slider change<br> color <strong><small><span class="code-color"></span></small></strong></p>
														</div>
														<div class=" clearfix align-lg-center">
															<div class="slider-color" id="red" data-color="danger"></div>
															<div class="slider-color" id="green" data-color="green"></div>
															<div class="slider-color" id="blue" data-color="primary"></div>
														</div>
												</div>
										</section>
										...
										<section class="panel">
												<header class="panel-heading">
														<h2> <strong>Flat</strong> modern </h2>
														<label class="color">slider modern style ( with Jquery UI )</label>
												</header>
												<div class="panel-tools  color " align="right" data-toolscolor="theme">
														<ul class="tooltip-area">
																<li><a href="javascript:void(0)" class="btn btn-collapse" title="Collapse"><i class="fa fa-sort-amount-asc"></i></a></li>
																<li><a href="javascript:void(0)" class="btn btn-reload"  title="Reload"><i class="fa fa-retweet"></i></a></li>
																<li><a href="javascript:void(0)" class="btn btn-close" title="Close"><i class="fa fa-times"></i></a></li>
												...
												<div class="panel-body">
														...
														<h4><strong>Single</strong> Slider </h4><hr>
														<div class="cp-slider-wrapper" data-color="theme-inverse" data-max="150">
																<input type="hidden" name="cp-slider" />
																<nav>
														...
														<h4><strong>Min</strong> Slider </h4><hr>
														...
														<h4><strong>Max</strong> Slider </h4><hr>
														<div class="cp-slider-wrapper" data-color="warning"  data-max="100" data-range="max" data-value="25">
																<input type="hidden" name="cp-slider-3" />
																<nav>
																		<a href="#" class="cp-prev"><i class="fa fa-chevron-left"></i></a>
																		<a href="#" class="cp-next"><i class="fa fa-chevron-right"></i></a>
																</nav>
														...
														<h4><strong>Not </strong> Open </h4>
														<label class="color"> Disabled event  when click open slider</label>
														<hr>
														<div class="cp-slider-wrapper"  data-max="5" data-opened="true">
																<input type="hidden" name="cp-slider-4"  />
																<nav>
																		<a href="#" class="cp-prev"><i class="fa fa-chevron-left"></i></a>
																		<a href="#" class="cp-next"><i class="fa fa-chevron-right"></i></a>
																</nav>
														...
														<div class="well corner-flip flip-bg-white" data-color="inverse">
															<h4><i class="fa fa-warning"></i> <strong>NOTE</strong> </h4>
															<p>Flat modern slider is not support multi value</p>
														</div>
