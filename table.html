								...
								<div class="col-lg-12">
										...
										<section class="panel">
												<header class="panel-heading">
														<h2><strong>Table</strong> Default </h2>
														<label class="color">Bootstrap Class<em><strong> table</strong></em></label>
												</header>
										...
										<section class="panel">
												<header class="panel-heading">
														<h2><strong>Table</strong> bordered </h2>
														<label class="color">Bootstrap Class<em><strong> table-bordered</strong></em></label>
												</header>
												<div class="panel-body">
										...
										<section class="panel">
												<header class="panel-heading">
														<h2><strong>Table</strong> striped </h2>
														<label class="color">Bootstrap Class<em><strong> table-striped</strong></em></label>
												</header>
												<div class="panel-body">
										...
										<section class="panel">
												<header class="panel-heading">
														<h2><strong>Table</strong> hover </h2>
														<label class="color">Bootstrap Class<em><strong> table-hover</strong></em></label>
												</header>
												<div class="panel-body">
										...
										<section class="panel">
												<header class="panel-heading">
														<h2><strong>Table</strong> Advace </h2>
