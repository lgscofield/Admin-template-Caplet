...
<div id="wrapper">
		...
		<div id="main">
				...
				<ol class="breadcrumb">
						...
						<li class="active">Touch to open</li>
				</ol>
				<!-- //breadcrumb-->
								...
								<div class="col-lg-12" >
										<section class="panel corner-flip">
												<header class="panel-heading">
														<h2><strong>Touch</strong> Open </h2>
												</header>
												...
												<div class="panel-body">
														<h4>All device( iOS Android and Dektop )</h4>
														<div class="touch-demo" id="touch-dragleft">
																<p><strong>drag</strong> left</p>
														</div>
														<div class="touch-demo" id="touch-dragright">
																<p><strong>drag</strong> Right</p>
														</div>
														<div class="touch-demo" id="touch-hold">
																<p><strong>touch</strong> hold</p>
														</div>
														<div class="touch-demo" id="touch-tap">
																<p><strong>touch</strong> tap</p>
														</div>
														<div class="touch-demo" id="touch-doubletap">
																<p><strong>double</strong>tap</p>
														</div>
														<div class="touch-demo" id="touch-swipeleft">
																<p><strong>swipe</strong> left</p>
														</div>
														<div class="touch-demo" id="touch-swiperight">
																<p><strong>swipe</strong> right</p>
														</div>
														<div class="code">
															<h4>Example code</h4>
<pre class="prettyprint lang-js">
//Drag Right
var dragright= Hammer( document.getElementById("touch-dragright") );
	dragright.on("dragright", function(event) {
	if((event.gesture.deltaY<=5 && event.gesture.deltaY>=-5) && event.gesture.deltaX <-100){
		$('nav#menu').trigger( 'open.mm' );
	}
});</pre>
	 														<h4>Or  you can use in all pages action( #wrapper )</h4>
<pre class="prettyprint lang-js">
...
<script>
	$(document).ready(function() {	
			 //Drag Left
			 var dragleft= Hammer( document.getElementById("touch-dragleft") );
			 dragleft.on("dragleft", function(event) {
				if((event.gesture.deltaY<=5 && event.gesture.deltaY>=-5) && event.gesture.deltaX <-100){
					$('nav#contact-right').trigger( 'open.mm' );
				}
			 });
			 ...
			 //Hold
			 var touchHold= Hammer( document.getElementById("touch-hold") );
			 touchHold.on("hold", function(event) {
					$('nav#menu').trigger( 'open.mm' );
			 });
			 
			 //Tap
			 var touchTap= Hammer( document.getElementById("touch-tap") );
			 touchTap.on("tap", function(event) {
					$('nav#contact-right').trigger( 'open.mm' );
			 });
			 
			 //doubleTap
			 var doubleTap= Hammer( document.getElementById("touch-doubletap") );
			 doubleTap.on("doubletap", function(event) {
					$('nav#menu').trigger( 'open.mm' );
			 });
			 
			 //Swipe Left
			 var swipeLeft= Hammer( document.getElementById("touch-swipeleft") );
			 swipeLeft.on("swipeleft", function(event) {
					$('nav#contact-right').trigger( 'open.mm' );
			 });
			 
			 //Swipe Right
			 var swipeRight= Hammer( document.getElementById("touch-swiperight") );
