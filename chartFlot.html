				...
				<div id="content">
						...
						<div class="row">
								...
								<div class="col-lg-8">
										...
										<section class="panel corner-flip">
												<header class="panel-heading no-borders">
														...
														<label class="color">Plugin <strong> Flot chart  graphtable</strong></label>
												</header>
												<div class="widget-chart chart-dark">
														<table class="flot-chart" data-type="bars" data-bar-width="0.8" data-tool-tip="show"  data-width="100%" data-height="220px"  >
																<thead>
																		<tr>
																				<th></th>
										...
										<section class="panel corner-flip">
												<header class="panel-heading no-borders">
														<h2><strong>Order</strong> Chart </h2>
														<label class="color">Plugin <strong>Order for Flot chart </strong></label>
												</header>
												<div class="widget-chart chart-dark">
														<div id="order" style="width:100%;height:270px;"></div>
												</div>
										</section>
										
										<section class="panel corner-flip">
												<header class="panel-heading no-borders">
														<h2><strong>Stack</strong> Chart </h2>
														<label class="color">Plugin <strong> Flot chart in table</strong></label>
												</header>
												<div class="widget-chart chart-dark">
														<table id="stack-chart" data-stack="true" class="flot-chart" data-type="bars"  data-yaxis-max="3000" data-tool-tip="show" data-width="100%" data-height="220px"  data-bar-width="0.2">
																<thead>
																		<tr>
																				<th></th>
																				<th style="color : #FFCC33;">Test</th>
																				<th style="color : #575757;">Page View</th>
																		</tr>
																</thead>
																<tbody>
																		<tr>
												...
												<footer class="panel-footer align-lg-center">
														<div class="btn-group chart-change ">
																<a  href="javascript:void(0)" class="btn btn-theme btn-transparent active" data-change-type="bars" data-for-id="#stack-chart">Bars</a>
																<a thref="javascript:void(0)" class="btn btn-theme btn-transparent " data-change-type="lines" data-for-id="#stack-chart">Lines</a>
														</div>
												</footer>
										</section>
										...
										<section class="panel corner-flip">
												<header class="panel-heading no-borders">
														<h2><strong>Different</strong> Chart </h2>
														<label class="color"> multi-types <strong>  in one graph</strong></label>
												</header>
												<div class="widget-chart chart-dark">
														<div id="multi-type" style="height:220px"></div>
												</div>
										</section>
								...
								<div class="col-lg-4">
										...
										<section class="panel corner-flip">
												<header class="panel-heading no-borders">
														<h2><strong>Real</strong> time</h2>
														<label class="color">Line Chart <strong>Real-time  update ( 5 sec)</strong></label>
												</header>
												<div class="widget-chart chart-dark">
										...
										<section class="panel corner-flip">
												<header class="panel-heading no-borders">
														...
														<label class="color">Donut Hole<strong> Flot pie</strong></label>
												</header>
												<div class="widget-chart" style=" padding-bottom:30px;">
														<table class="flot-chart" data-type="pie" data-inner-radius="0.4"  data-pie-label="show" data-pie-style="shadow"  data-width="100%" data-height="220px" data-toolstip="false">
																<thead>
																		<tr>
																				<th></th>
																				<th style="color : #FFCC33;">Product Review</th>
																				<th style="color : #E15258;">Article</th>
																				
																				<th style="color : #F37864;">Article</th><th style="color : #575757;">Webboard</th>
...
<script type="text/javascript">
	$(function() {
		// Flot Chart Real Time  Call on this page only	 
		...
		var plot = $.plot("#placeholder", [ getRandomData() ], {
			...
			yaxis: { tickColor: "rgba(0,0,0,0.2)" ,min: 0, max: 30,},  
		...
		// Flot  Different  Chart  Call on this page only	 
		var d1 = [["JAN", 4295], ["FEB", 5145], ["Mar", 2015], ["APR", 2500],["MAY", 7850], ["JUN", 15700], ["JUL", 9315], ["AUG", 2100],["SEP", 5605], ["OCT", 1900], ["NOV", 12500], ["DEC", 9845]];
		var d2 = [["JAN", 4205], ["FEB", 5105], ["Mar", 1005], ["APR", 2490],["MAY", 1000], ["JUN", 15000], ["JUL", 2015], ["AUG", 2000],["SEP", 5505], ["OCT", 1800], ["NOV", 1800], ["DEC", 9845]];
		$.plot("#multi-type", [{
			label: '2012', data: d1, bars: { show: true, barWidth:  0.8, fill:  1, align: "center"  }
		}, {
			label: '2013', data: d2, lines: { show: true  }
		}],{
				 colors: ["#575757" ,"#E94028"],
				 xaxis: { mode: "categories", tickLength: 0 },
				  yaxis: { tickColor: "rgba(0,0,0,0.2)" ,
	...
	var data = [
	    { label: "PASS", data: build_pass_data },
	    { label: "FAIL", data: build_fail_data }
	];
	...
	var options = {
		    xaxis: {
			  min: 0,  max:6,
			  mode: null,
			  ticks: [  [1, "app4"],    [2, "app5"],   [3, "app6"],  [4, "app7"],     [5, "app8"]
			  ],
			  tickLength: 0
		    }, yaxis: {
			  tickFormatter: function number(x) {  var num; if (x >= 1000) { num=(x/1000)+"k"; }else{ num=x; } return num; }
		    },  
		    colors:["#62707d","#736086"],
		    grid: { borderWidth: {top: 0, right: 0, bottom: 1, left: 1} }, 
		    series: {
			  bars: {  show: true,  barWidth: 0.13, fill: 1 ,align: 'center',  order: 1 }
		    },
		    tooltip: true 
	 };
	 $(function() {
	     $.plot($('#order'), data, options);
	 });
</script>
</body>
</html>
