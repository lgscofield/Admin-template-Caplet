...
<div id="wrapper">
		...
		<div id="header">
				...
				<div class="tools-bar">
						<ul class="nav navbar-nav nav-main-xs">
								<li><a href="#menu-ver" class="icon-toolsbar"><i class="fa fa-bars"></i></a></li>
						</ul>
						<ul class="nav navbar-nav navbar-right tooltip-area">
								...
								<li><a href="#" class="h-seperate">Help</a></li>
								...
								<li class="dropdown">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">
											<strong>Hi</strong>, Nutprawee <i class="dropdown-icon fa fa-angle-down"></i>
										</a>
		...
		<div id="main">
				...
				<ol class="breadcrumb">
						...
						<li class="active">Vertical Level menu</li>
				</ol>
				<!-- //breadcrumb-->
								...
								<div class="col-lg-12" >
										...
										<section class="panel corner-flip">
												<header class="panel-heading">
														<h2><strong>Menu</strong> Vertical </h2>
												</header>
												...
												<div class="panel-body">
														<div class="code">
															<h4>Can you user java script code</h4>
<pre class="prettyprint lang-js">
	$('nav#menu').mmenu({
		...
		slidingSubmenus	: false //  change setting slidingSubmenus from true to false
														...
														<br>
														<h4>You can see when open submenu</h4><br>
														<p><a href="#menu-ver" class="btn btn-theme">Open Vertical</a></p>
												</div>
										</section>
								</div>
