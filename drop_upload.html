								...
								<div class="col-lg-12">
										<section class="panel corner-flip">
												<header class="panel-heading no-borders">
														<h2><strong>Drop</strong> Upload </h2>
												</header>		
												<div class="panel-body">
														<div id="dropzone">
															<form action="data/dropupload.php" class="dropzone" id="demo-upload">
																<div class="fallback">
...
<!-- Library drop upload-->
<script type="text/javascript" src="assets/plugins/dropupload/dropzone.min.js"></script>
<link href="assets/plugins/dropupload/css/dropzone.css" rel="stylesheet" />
