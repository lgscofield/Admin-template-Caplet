...
<div id="wrapper">
								...
								<div class="col-lg-12" >
										...
										<section class="panel">
												<header class="panel-heading">
														<h2><strong>Crop</strong> image </h2>
												</header>
																	...
																	<div class="col-md-6 col-md-offset-3">
																			<form>
																					<div class="form-group">
																							<div>
																									<button type="button" class="btn btn-inverse btn-crop-enable"><i class="fa fa-crop"></i> Enable crop</button>
																									<div class="crop_tools" style="display:none;">
																											<button type="button" class="btn btn-inverse btn-crop-disable"><i class="fa fa-times"></i> Cancel crop</button>
																											<button type="button" class="btn btn-danger"><i class="fa fa-floppy-o"></i></button>
																									</div>
																							</div>
																					</div><!-- //form-group-->
																					<div class="form-group">
																							<img id="crop_image" class="img-responsive" src="assets/photos_preview/large/1.jpg"/>
																					</div><!-- //form-group-->
																					<hr>
																					<button type="button" class="btn btn-danger md-crop-load">Modal Crop</button>
																			</form>
										...
										<section class="panel">
												<header class="panel-heading">
														<h2><strong>Crop</strong> and upload </h2>
												</header>
												<div class="panel-body">
															<div class="row">
																	<div class="col-md-6 col-md-offset-3">
																			<form id="coords" class="coords"  action="data/crop-imges.php" method="post" enctype="multipart/form-data">
																					<div class="form-group">
																							<div>
																									...
																									<button type="button" class="btn btn-danger btn-crop-upload disabled pull-right" style="display:none">Upload</button>
		...
		<div id="md-crop" class="modal fade md-slideRight" tabindex="-1" data-width="750" data-header-color="theme-inverse">
				<div class="modal-body modal-crop">
						<div class="row">
								<div class="col-md-8">
										<img id="crop_image_modal" class="img-responsive" src="assets/photos_preview/large/3.jpg"/>
								</div><!-- //col-md-8-->
								<div class="col-md-4">
