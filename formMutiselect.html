...
<div id="wrapper">
		...
		<div id="main">
				...
				<ol class="breadcrumb">
						...
						<li class="active"> Mulit Select</li>
				</ol>
				<!-- //breadcrumb-->
								...
								<div class="col-lg-12" >
										...
										<section class="panel">
												<header class="panel-heading">
														...
														<label class="color"> multiSelect v 0.9.11 plugins</label>
												</header>
										...
										<section class="panel">
												<header class="panel-heading">
														<h2><strong>multi</strong> Select </h2>
														<label class="color"> Callbacks Value</label>
												</header>
												<div class="panel-body">
														<form class="form-horizontal" data-collabel="3" data-label="color">
																<div class="form-group">
																		...
																		<div>
																				  ...
																				  <select  id="callbacks" multiple="multiple"  name="searchable[]">
																						<option value="elem_1">elem 1</option>
																						<option value="elem_2">elem 2</option>
																						<option value="elem_3">elem 3</option>
																						<option value="elem_4">elem 4</option>
