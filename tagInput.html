								...
								<div class="col-lg-12" >										
														...
														<section class="panel">
																<header class="panel-heading">
																		<h2><strong>Tags </strong> inputs </h2>
																...
																<div class="panel-body">
																		...
																		<form class="form-horizontal" data-collabel="3" data-label="color">
																				<div class="form-group">
																						<label class="control-label">Input [data-role] </label>
																						<div>
																								<input type="text" class="form-control" data-role="tagsinput"  value="Flat design, template,  admin" />
																						</div>
																				</div>
																				<div class="form-group">
																						<label class="control-label">With ID </label>
																						<div>
																								<input type="text" class="form-control" id="tagsinput"  value="Flat design, template,  admin" />
														<h4>Html Code</h4>
