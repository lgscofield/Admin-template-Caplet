		...
		<div id="main">
				...
				<div class="tabbable">
						<ul id="profile-tab" class="nav nav-tabs" data-provide="tabdrop">
								...
								<li><a href="#tab3" data-toggle="tab" class="portfolio-show">Videos</a></li>
						...
						<div class="tab-content row resultSearch">
										<div class="tab-pane fade in active col-lg-8" id="tab1">		
											<small class="resultStats">About 406,000 results (0.15 seconds)</small>	
											<ul class="resultItem">	
													<li>
															<h4><a href="#">Caplet Admin Responsive Html Theme</a></h4>
															<a href="#">http://www.caplet.zicedemo.com/</a>
															<p>
																<time datetime="01-15-2014"> Jan 15, 2014 - </time>  Caplet Admin is modern flat admin template , based on Bootstrap Framework 3+HTML5+CSS3 more plugin includes for all purpose use...
															</p>
													</li>	
													<li>
															<h4><a href="#">Caplet Admin Responsive HTML Theme - ThemeForest</a></h4>
															<a href="#">themeforest.net &rsaquo; Files &rsaquo; Site Templates &rsaquo;  Admin Templates‎</a>
															<div class="rating">
																	...
																	<span>Rating: 4.8 - ‎10 votes - ‎$18.00</span>
															</div>
															<p>
																<time datetime="01-09-2014"> Jan 9, 2014 - </time> Caplet Admin is modern flat admin template , based on Bootstrap Framework 3+HTML5+CSS3 more plugin includes for all purpose use...
															</p>
													</li>	
													<li>
															<h4><a href="#">45 html Bootstrap Admin templates for website admin panel ...</a></h4>
															<a href="#">http://www.caplet.zicedemo.com/</a>
															<p>
																<time datetime="01-15-2014"> Jan 15, 2014 - </time>  Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat...
															</p>
													</li>	
													<li>
															<h4><a href="#">Caplet Admin Responsive HTML Theme (Admin Templates)</a></h4>
															<a href="#">themeforest.net &rsaquo; Files &rsaquo; Site Templates &rsaquo;  Admin Templates‎</a>
															<p>
																<time datetime="01-09-2014"> Jan 9, 2014 - </time> Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat...
															</p>
													</li>	
													<li>
															<h4><a href="#">Caplet Admin Responsive Html Theme</a></h4>
										...
										<div class="tab-pane fade col-lg-8" id="tab2">
											<small class="resultStats">About 250 results (0.05 seconds)</small>	
											<div class="row">
													<div class="col-sm-4">
														<ul class="resultItem resultImages">	
																<li><a href="assets/photos_preview/large/1.jpg" class="swipebox" title="My Caption">
																<img src="assets/photos_preview/thumbs/1.jpg" ></a></li>
																<li><a href="assets/photos_preview/large/2.jpg" class="swipebox" title="My Caption">
																<img src="assets/photos_preview/thumbs/2.jpg" ></a></li>
																<li><a href="assets/photos_preview/large/3.jpg" class="swipebox" title="My Caption">
																<img src="assets/photos_preview/thumbs/3.jpg" ></a></li>
																<li><a href="assets/photos_preview/large/4.jpg" class="swipebox" title="My Caption">
																<img src="assets/photos_preview/thumbs/4.jpg" ></a></li>
														</ul>
													</div>
													<div class="col-sm-4">
														<ul class="resultItem resultImages">	
																<li><a href="assets/photos_preview/large/5.jpg" class="swipebox" title="My Caption">
																<img src="assets/photos_preview/thumbs/5.jpg" ></a></li>
																<li><a href="assets/photos_preview/large/6.jpg" class="swipebox" title="My Caption">
																<img src="assets/photos_preview/thumbs/6.jpg" ></a></li>
																<li><a href="assets/photos_preview/large/7.jpg" class="swipebox" title="My Caption">
																<img src="assets/photos_preview/thumbs/7.jpg" ></a></li>
																<li><a href="assets/photos_preview/large/8.jpg" class="swipebox" title="My Caption">
																<img src="assets/photos_preview/thumbs/8.jpg" ></a></li>
														</ul>
													</div>
													<div class="col-sm-4">
														<ul class="resultItem resultImages">	
																<li><a href="assets/photos_preview/large/9.jpg" class="swipebox" title="My Caption">
																<img src="assets/photos_preview/thumbs/9.jpg" ></a></li>
																<li><a href="assets/photos_preview/large/10.jpg" class="swipebox" title="My Caption">
																<img src="assets/photos_preview/thumbs/10.jpg" ></a></li>
																<li><a href="assets/photos_preview/large/11.jpg" class="swipebox" title="My Caption">
																<img src="assets/photos_preview/thumbs/11.jpg" ></a></li>
																<li><a href="assets/photos_preview/large/empty.jpg" class="swipebox" title="My Caption">
																<img src="assets/photos_preview/thumbs/empty.jpg" ></a></li>
														</ul>
													</div>
											</div>
										</div>
										...
										<div class="tab-pane fade col-lg-8" id="tab3">
											<small class="resultStats">About 547 results (0.55 seconds)</small>	
											<ul class="resultItem">	
													<li class="clearfix">
															<div class="resultThumbnail col-md-2"><img src="assets/photos_preview/thumbs/video.jpg"></div>
															<div class="resultLink col-md-10">
																	<h4><a href="#">Caplet Admin Responsive Html Theme</a></h4>
																	<a href="#">http://www.youtube.com/watch?v=elIcTMjUZcg</a>
																	<p>
																		<time datetime="01-09-2014"> Jan 09, 2014 - </time>  Caplet Admin is modern flat admin template , based on Bootstrap Framework 3+HTML5+CSS3 more plugin includes for all purpose use...
																	</p>
															</div>
													</li>	
													<li class="clearfix">
										...
										<div class="tab-pane fade col-lg-8" id="tab4">
											<small class="resultStats">About 59 results (0.55 seconds)</small>	
											<div class="table-responsive">
													<table class="table table-striped table-bordered table-hover">
															...
															<tbody align="center">
																	<tr>
																			<td><img src="assets/img/avatar.png" alt="" class="avatar-small"></td>
																			<td> Mark Nilson </td>
																			<td> makr124 </td>
																			<td><span class="label label-sm label-success"> Approved </span></td>
																			<td><a class="btn btn-theme" href="#"><i class="fa fa-search"></a></td>
																	</tr>
																	<tr>
																			<td><img src="assets/img/avatar2.png" alt="" class="avatar-small"></td>
																			<td> Filip Rolton </td>
																			<td> jac123 </td>
																	...
																	<tr>
																			<td><img src="assets/img/avatar3.png" alt="" class="avatar-small"></td>
																			<td> Colin Fox </td>
																			<td> col </td>
																			<td><span class="label label-sm label-success"> Approved </span></td>
																			<td><a class="btn btn-theme" href="#"><i class="fa fa-search"></a></td>
																	...
																	<tr>
																			<td><img src="assets/img/avatar5.png" alt="" class="avatar-small"></td>
																			<td> Edward Cook </td>
																			<td> sanlim </td>
																			<td><span class="label label-sm label-success"> Approved </span></td>
																			<td><a class="btn btn-theme" href="#"><i class="fa fa-search"></a></td>
																	...
																	<tr>
																			<td><img src="assets/img/avatar6.png" alt="" class="avatar-small"></td>
																			<td> Elis Lim </td>
																			<td> makr124 </td>
																			<td><span class="label label-sm label-success"> Approved </span></td>
																			<td><a class="btn btn-theme" href="#"><i class="fa fa-search"></a></td>
																	...
																	<tr>
																			<td><img src="assets/img/avatar4.png" alt="" class="avatar-small"></td>
																			<td> Martin Larson </td>
																			<td> larson12 </td>
																			<td><span class="label label-sm label-danger"> Blocked </span></td>
																			<td><a class="btn btn-theme" href="#"><i class="fa fa-search"></a></td>
										...
										<div class="col-lg-4">
												...
												<form>
												<h3><strong>SEARCH</strong> Setting </h3>
												<hr>
												<div class="form-group">
														<input class="form-control" type="text" placeholder="Search... ">
												</div>
												<div class="form-group">
														<select  class="selectpicker form-control" multiple title="Choose language" data-style="btn-inverse">
												...
												<div class="form-group">
														<ul class="iCheck"  data-color="red">
																<li>
																		<input type="checkbox">
																		<label>Search in users rows (optional)</label>
																</li>
																<li>
																		<input type="checkbox" checked>
																		<label>Text Highlight (optional)</label>
																</li>
														</ul>	
												</div>
												<div class="form-group">
														<label class="color">Result Item</label>
												...
												<div class="tooltip-area">
														<button type="submit" class="btn btn-theme" title="Search">Search</button>
												</div>
												</form>
										</div>
...
<!-- The Swipebox plugin -->
<link href="assets/plugins/gallery/swipebox/swipebox.css" rel="stylesheet" />
<script type="text/javascript" src="assets/plugins/gallery/swipebox/jquery.swipebox.min.js"></script>
<script type="text/javascript">
$(document).ready(function () {
	$("#SliderSingle").jslider({ from: 0, to: 100, step: 1, round: 0, dimension: '' });
	//////////     Swipebox IMAGES     //////////
	$(".swipebox").swipebox();
});
</script>
