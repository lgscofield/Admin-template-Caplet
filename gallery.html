...
<div id="wrapper">
		...
		<div id="main">
				...
				<div class="tabbable">
						<ul class="nav nav-tabs" data-provide="tabdrop">
								...
								<li class="active"><a href="#tab1" data-toggle="tab">Albums</a></li>
								<li><a href="#tab2" data-toggle="tab">Photo</a></li>
								<li><a href="#tab3" data-toggle="tab">Like</a></li>
						</ul>
						<div class="tab-content">
								...
								<div class="tab-pane fade in active" id="tab1">
									<div>
											<div class="btn-group pull-right">
													<button class="btn btn-inverse active"><i class="fa fa-bars"></i></button>
													<button class="btn btn-inverse"><i class="fa fa-th"></i></button>
											</div>
											<h2><strong>ALL</strong> 33 Albums</h2>
									</div>
									<hr>
									<div class="row row-clear gallery-albums">
											<div class="col-sm-3">
													<h3>Working On</h3>
													<label  class="color">15 Photo, 05 Dec 2103</label>
													<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
													<button class="btn btn-theme-inverse">Open Albums</button>
											</div>
											<div class="col-sm-3">
													<img src="assets/photos_preview/thumbs/1.jpg" class="img-preview" alt="Preview">
											</div>
											<div class="col-sm-3">
													<img src="assets/photos_preview/thumbs/2.jpg" class="img-preview" alt="Preview">
											</div>
											<div class="col-sm-3">
													<img src="assets/photos_preview/thumbs/3.jpg" class="img-preview" alt="Preview">
											</div>
											<div class="clearfix"></div>
											<hr>
											<div class="col-sm-3">
													<h3>The eyes have it</h3>
													<label  class="color"> 81 Photo, 27 Sep 2103</label>
													<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
													<button class="btn btn-theme-inverse">Open Albums</button>
											</div>
											<div class="col-sm-3">
													<img src="assets/photos_preview/thumbs/4.jpg" class="img-preview" alt="Preview">
											</div>
											<div class="col-sm-3">
													<img src="assets/photos_preview/thumbs/5.jpg" class="img-preview" alt="Preview">
											</div>
											<div class="clearfix"></div>
											<hr>
											<div class="col-sm-3">
													<h3>Pimelea plants of Australia</h3>
													<label  class="color"> 54 Photo, 26 Sep 2103</label>
													<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
													<button class="btn btn-theme-inverse">Open Albums</button>
											</div>
											<div class="col-sm-3">
													<img  src="assets/photos_preview/thumbs/6.jpg" class="img-preview" alt="Preview">
											</div>
											<div class="col-sm-3">
													<img src="assets/photos_preview/thumbs/7.jpg" class="img-preview" alt="Preview">
											</div>
											<div class="col-sm-3">
													<img src="assets/photos_preview/thumbs/8.jpg" class="img-preview" alt="Preview">
											</div>
											<div class="clearfix"></div>
											<hr>
											<div class="col-sm-3">
											...
											<div class="col-sm-3">
													<img src="assets/photos_preview/thumbs/9.jpg" class="img-preview" alt="Preview">
											</div>
											<div class="clearfix"></div>
											<hr>
											<div class="col-sm-3">
											...
											<div class="col-sm-3">
													<img src="assets/photos_preview/thumbs/10.jpg" class="img-preview" alt="Preview">
											</div>
											<div class="col-sm-3">
													<img src="assets/photos_preview/thumbs/11.jpg" class="img-preview" alt="Preview">
											</div>
											<div class="clearfix"></div>
											<hr>
											<div class="pull-right">
													<button class="btn btn-theme disabled">Newer</button>
													<button class="btn  btn-theme">Older</button>
											</div>
									</div>
								</div>
								<!-- //tab1 -->
								...
								<div class="tab-pane fade" id="tab2">
										<div>
												<div class="btn-group pull-right">
														<button class="btn btn-inverse active"><i class="fa fa-th"></i></button>
														<button class="btn btn-inverse" id="fullScreen"><i class="fa fa-laptop"></i></button>
												</div>
												<h2><strong>1,845</strong>  Photo.</h2>
										</div>
										<hr>
		...
		//////////////////////////////////////////////////////
		-->
		<div id="md-crop" class="modal fade md-slideRight" tabindex="-1" data-width="750" data-header-color="theme-inverse">
				<div class="modal-body modal-crop">
						<div class="row">
								<div class="col-md-8">
										<img id="crop_image_modal" class="img-responsive"/>
								</div><!-- //col-md-8-->
								<div class="col-md-4">
										...
										<form>
												<div class="form-group">
														<h4><strong>IMAGE</strong> Editor</h4><br>
														<div>
																<textarea class="form-control" placeholder="Image title..." ></textarea>
														</div>
												</div><!-- //form-group-->
												<div class="form-group">
														<div>
																<button type="button" class="btn btn-inverse btn-crop-enable"><i class="fa fa-crop"></i></button>
...
$(function() {
			...
			var jcrop_api   ;
			var btnCrop=$('.btn-crop-enable');
			$('body').on("click",".md-crop-load", function(){
				var img=$(this).data("img");
				  $('#crop_image_modal').attr("src",img)
				  $('body').modalmanager('loading');
				  if(typeof  jcrop_api != 'undefined'){ jcrop_api.destroy(); btnCrop.removeClass('disabled'); }
				  setTimeout(function(){
						  $("#md-crop").modal();
				  }, 500);
			});
		...
		btnCrop.click(function(e) {
				$('#crop_image_modal').Jcrop({ aspectRatio:4/3 },function(){
					jcrop_api = this;
					 jcrop_api.animateTo([150,100,360,300]);
				});
