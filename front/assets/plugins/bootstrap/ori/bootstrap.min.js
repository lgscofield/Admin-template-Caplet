...
(function($) {
    ...
    Progressbar.prototype.transition = function() {
	   ...
	   var $tooltip=$('<div class="progress-tooltip"/>')
        ...
        setTimeout(function() {
            ...
            var progress = setInterval(function() {
                ...
                if (options.display_text !== 'none') {
                   ...
                   else if (options.display_text ===  'tooltip') {
...
!function ($) {
	...
	* ======================= */
	...
	$.fn.modalmanager.defaults = {
		backdropLimit: 999,
		resize: true,
		spinner: '<div class="loading-spinner fade" style="width: 200px; margin-left: -100px;"><div class="progress progress-striped active"><div class="progress-bar progress-bar-theme" role="progressbar" aria-valuenow="100" style="width: 100%"></div></div><div class="txtLoad">Loading...</div></div>',
...
!function( $ ) {
	...
	var TabDrop = function(element, options) {
		this.element = $(element);
		this.padding=parseInt(this.element.css("padding-top"));
		this.dropdown = $('<li class="dropdown hide pull-right tabdrop"><a class="dropdown-toggle" data-toggle="dropdown" href="#">'+options.text+' <span class="badge"></span></a><ul class="dropdown-menu"></ul></li>')
	...
	TabDrop.prototype = {
		...
		layout: function() {
			...
			if (collection.length > 0) {
				...
				this.dropdown.find('.badge').text(collection.length);
