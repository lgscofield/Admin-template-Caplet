								...
								<section class="collapse in" id="collapseSummary">
										<div class="collapse-boby" style="padding:0">
												...
												<div class="widget-mini-chart align-xs-right">
														<div class="pull-left">
																<div class="sparkline mini-chart" data-type="bar" data-color="#FFCC33" data-bar-width="10" data-height="45">2,3,7,5,4,6,6,3</div>
														</div>
														<p>This week sales</p>
														<h4>1,325 item</h4>
												</div>
								...
								<div class="col-lg-12">
										<section class="panel corner-flip">
												<header class="panel-heading no-borders">
														<h2><strong>File</strong> Manager </h2>
														<label class="color">Plugin  <strong>elfinder 2.0</strong></label>
												</header>		
...
<!-- Library elfinder -->
<script type="text/javascript" src="assets/plugins/elfinder/js/elfinder.min.js"></script>
<link rel="stylesheet" type="text/css" media="screen" href="assets/plugins/elfinder/css/elfinder.min.css">
<link rel="stylesheet" type="text/css" media="screen" href="assets/plugins/elfinder/css/theme.css">
