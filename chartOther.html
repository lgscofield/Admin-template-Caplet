...
<div id="wrapper">
		...
		<div id="main">
				...
				<ol class="breadcrumb">
						...
						<li class="active">Chart Other</li>
				</ol>
				<!-- //breadcrumb-->
				...
				<div id="content">
						...
						<div class="row">
								...
								<div class="col-lg-12">
										...
										<div class="row">
												<div class="col-sm-4">
														<section class="panel corner-flip">
																<header class="panel-heading no-borders">
																		...
																		<label class="color">Plugin  <strong>Sparkline  Chart (inline)</strong></label>
																</header>		
																<div class="panel-body align-lg-center">																												
																		<div class="sparkline" data-type="bar" data-color="theme" data-bar-width="10"  data-height="100">4,5,-1,4,5,4,-4,-2,4,5,6,4</div>
																		<div class="label-sparkline align-lg-center">
																				<ul>
																						<li><span data-color="theme"></span>Bar Label Chart </li>
																				</ul>
																		</div>
												...
												<div class="col-sm-4">
														<section class="panel">
																<header class="panel-heading no-borders">
																		...
																		<label class="color">Plugin  <strong> sparkline ( resize ) </strong></label>
																</header>		
																<div class="panel-body">	
																									
																		<div class="sparkline" data-type="line" data-color="theme" data-height="100" data-data="[4295, 5145,2500, 2500, 9315, 15700, 9315, 2100, 5605, 1900, 1900, 1900]"></div>
																		<div class="label-sparkline align-lg-center">
																				<ul>
																						<li><span data-color="theme"></span>Last Year (2012)</li>
																				</ul>
																		</div>
												...
												<div class="col-sm-4">
														<section class="panel corner-flip">
																<header class="panel-heading no-borders">
																		<h2><strong>Bar</strong> Chart </h2>
																		<label class="color">Plugin  <strong> sparkline  ( Stacked  )</strong></label>
																</header>		
																<div class="panel-body align-lg-center">																												
																		<div class="sparkline" data-type="bar" data-bar-width="15" data-bar-spacing="2"  data-height="100" 
																		 data-stacked-bar-color='["#6CC3A0", "#ededed"]'>4:6,6:4,4:6,5:5,7:3,4:6,5:5</div>
																		<div class="label-sparkline align-lg-center">
																				<ul>
																						<li><span data-color="#6CC3A0"></span>Label Chart </li>
																						<li><span data-color="#ededed"></span>Label Chart 2</li>
																				</ul>
																		</div>
																</div>
														</section>		
										...
										<div class="row">												
												...
												<div class="col-sm-5">
														<section class="panel">
																<header class="panel-heading no-borders">
																		...
																		<label class="color">Plugin  <strong> sparkline</strong></label>
																</header>		
																<div class="panel-body align-lg-center">										
																		<div class="sparkline" data-type="pie" data-color="theme" data-height="150" data-slice-colors='["#575757","#FFCC33"]'>44,8</div>																		
																		<div class="label-sparkline align-lg-center">
																				<ul>
																						<li><span data-color="#575757"></span>Label Chart </li>
																						<li><span data-color="#FFCC33"></span>Label Chart 2</li>
																				</ul>
																		</div>
												...
												<div class="col-sm-7">
														<section class="panel corner-flip">
																<header class="panel-heading no-borders">
																		<h2><strong>line</strong> Chart </h2>
																		<label class="color">Plugin  <strong> sparkline  ( composite  )</strong></label>
																</header>		
																<div class="panel-body align-lg-center">																												
																		<div class="sparkline" data-type="line" data-color="warning" data-height="150" data-data="[4295, 5145,2500, 2500, 4521, 15700, 4521, 2100, 5605, 1900, 1900, 1900]" data-composite-form="#composite"></div>
																		<div id="composite" data-color="inverse"  data-data="[295, 3145,5515, 4515, 15090, 4512, 4235, 1215, 2315, 5315, 2015, 315]"></div>
																		<div class="label-sparkline align-lg-center">
																				<ul>
																						<li><span data-color="warning"></span>Label Chart </li>
																						<li><span data-color="inverse"></span>Label Chart 2</li>
																				</ul>
																		</div>
										...
										<section class="panel corner-flip">
												<header class="panel-heading no-borders">
														<h2><strong>easypie</strong> Chart </h2>
														<label class="color">Plugin  <strong> Easypie Chart</strong></label>
												</header>		
												<div class="panel-body align-lg-center">
														<div class="row">
																<div class="col-sm-4">
																	<h4><strong>Used</strong> Space</h4><br>
																	<span class="easy-chart" data-percent="75" data-color="#575757" data-track-color="#FFCC33" data-line-width="25" data-size="150" data-shadow="true">
																			<span class="percent"></span>
																	</span>
																</div><!-- // col-sm-4-->
																
																<div class="col-sm-4">
																	<h4><strong>New</strong> Oders</h4><br>
																	<span class="easy-chart" data-percent="55" data-color="theme-inverse"  data-size="150" >
																			<span class="percent up"></span>
																	</span>
																</div><!-- // col-sm-4-->
																
																<div class="col-sm-4">
																	<h4><strong>New</strong> Visitors</h4><br>
																	
																	<span class="easy-chart" data-percent="65" data-color="danger"  data-track-color="#575757"  data-line-cap="round" data-line-width="15" data-size="150" data-start-angle="18" data-shadow="true">
																			<span class="percent down"></span>
																	</span>
																</div><!-- // col-sm-4-->
																
														</div><!-- // row-->
														<p><br><button class=" btn btn-info js_update"><i class="fa fa-refresh"></i> Update Chart</button></p>
												</div>
										</section>		
										...
										<section class="panel corner-flip">
												<header class="panel-heading no-borders">
														<h2><strong>Knob</strong> Chart </h2>
														<label class="color">Plugin  <strong> jQuery Knob </strong></label>
												</header>		
												<div class="panel-body align-lg-center">
														<div class="row">
																<div class="col-sm-4">
																	<h4><strong>Your</strong> Score <small>( readonly )</small></h4><br>
																	<input class="knob"  data-animate="true"  data-thickness="0.2" data-width="150" data-height="150"  data-angleOffset="-125" data-angleArc="250" data-color="inverse" value="59" readonly>
																	
																</div><!-- // col-sm-4-->
																
																<div class="col-sm-4">
																	<h4><strong>Add</strong> Item <small>( Custom )</small></h4><br>
																	<input class="knob"  name="add_item" id="add_item"  data-animate="true"  data-thickness="0.2" data-width="150" data-height="150" data-color="theme" data-display-previous="true"  value="22" data-linecap="round"  >
																	
																</div><!-- // col-sm-4-->
																
																<div class="col-sm-4">
																	<h4><strong>Last</strong> Point <small>( readonly )</small></h4>
																	<br>
																	<input class="knob"  data-animate="true"  data-cursor="true" data-thickness="0.4" data-width="150" data-height="150"  data-color="danger"  data-bgColor="#575757" data-linecap="round" value="27" readonly>
																	
																</div><!-- // col-sm-4-->
																
														</div><!-- // row-->
														<p><br><button class=" btn btn-info knob_save"><i class="fa fa-floppy-o"></i> Save Item</button></p>
												</div>
										</section>		
